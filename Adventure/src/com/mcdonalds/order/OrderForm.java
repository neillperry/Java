...
public class OrderForm extends JFrame {
    ...
    private void createImageIcons() {
        ImageIcon mcdonaldsLogo = new ImageIcon(this.getClass().getResource("../images/mcDonaldLogo.jpg"));
        ImageIcon archesLogo = new ImageIcon(this.getClass().getResource("../images/arches.png"));
